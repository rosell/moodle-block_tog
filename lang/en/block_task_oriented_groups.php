...
$string['composite_groups_pattern_help'] = 'The pattern used to generate the name of teh teams. The {} will be replaced by the index of the generated group.';
$string['composite_students_per_group'] = 'Students per group';
$string['composite_students_per_group_help'] = 'The number of studetns that has to be on each generated group.';
...
$string['composite_column_actions'] = 'Actions';
