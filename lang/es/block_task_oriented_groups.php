...
$string['composite_column_personality_not_filled'] = 'El usuario ha rellenado el test de personalidad.';
$string['composite_column_personality_filled'] = 'El usuario no ha rellenado el test de personalidad.';
$string['composite_column_intelligences'] = 'Rellenar prueba de inteligencias';
$string['composite_column_intelligences_not_filled'] = 'El usuario ha rellenado el test de inteligencias.';
$string['composite_column_intelligences_filled'] = 'El usuario no ha rellenado el test de inteligencias.';
